...
▶ 사용 전 준비
  - 학습 탭에서 모델 학습이 완료되어야 사용 가능합니다.
  -학습 완료 후 predictions.json 파일이 자동 생성됩니다.
...
▶ 예측 경로 비교
  - 초록색 화살표: 실제 주행 경로(real_angle / real_throttle)
  - 빨간색 화살표: AI 예측 경로(pred_angle / pred_throttle)
  - 화살표 길이는 속도값에 비례합니다.

▶ 수치 비교
  -실제 속도 / 앵글과 AI 예측 속도 / 앵글을 수치로 비교합니다.
  -오차가 0.1 미만이면 초록색, 이상이면 빨간색으로 표시됩니다.";
    }
